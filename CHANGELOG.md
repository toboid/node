...
* [[`7a9c8d8f10`](https://github.com/nodejs/node/commit/7a9c8d8f10)] - **process**: add process.cpuUsage() - implementation, doc, tests (Patrick Mueller) [#10796](https://github.com/nodejs/node/pull/10796)
